...
require Exporter;
@ISA = qw(Exporter);
@EXPORT = qw(ReadLenConfirmFromBam ReadLenConfirmFromFq CigarSplit CigarLenCheck ReadCoverRange BamItemGet MDSplit AltGet IfUnMap);
...
sub AltGet
{
	...
	for my $i (0 .. $#Items)
	{
		...
		{
			# insertion;
			# 此时需要小心第一位为I，比如“rg0013:2071925  pPr1    chr13   105997508       60      7H1I86M”，此时跳过即可;
			unless($AltId > 0)
			{
				for my $j (1 .. $Items[$i][1])
				{
